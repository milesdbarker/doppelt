...
WILD_MARK_COLORS: frozenset[Color] = frozenset({Color.YELLOW, Color.GREEN, Color.PINK, Color.SILVER})

# Colors selectable when resolving a silver-area mark (value × color grid).
SILVER_MARK_COLORS: frozenset[Color] = frozenset({Color.YELLOW, Color.BLUE, Color.GREEN, Color.PINK})
